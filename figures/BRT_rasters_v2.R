...
# read in zero models
zero_br <- rast("output/habmod/predictions/brt_zero_pred_bullroad_13.tif")
zero_br2 <- rast("output/habmod/predictions/brt_zero_pred_bullroad_14.tif")
zero_cb <- rast("output/habmod/predictions/brt_zero_pred_cowbay_13.tif")
zero_cb2 <- rast("output/habmod/predictions/brt_zero_pred_cowbay_14.tif")
zero_sj <- rast("output/habmod/predictions/brt_zero_pred_steeplejason_13.tif")

# average br and cb rasters
zero_br <- (zero_br + zero_br2) / 2
zero_cb <- (zero_cb + zero_cb2) / 2
...
intensity_br <- rast("output/habmod/predictions/brt_intensity_pred_bullroad_13.tif")
intensity_br2 <- rast("output/habmod/predictions/brt_intensity_pred_bullroad_14.tif")
intensity_cb <- rast("output/habmod/predictions/brt_intensity_pred_cowbay_13.tif")
intensity_cb2 <- rast("output/habmod/predictions/brt_intensity_pred_cowbay_14.tif")
intensity_sj <- rast("output/habmod/predictions/brt_intensity_pred_steeplejason_13.tif")

# average br and cb rasters
intensity_br <- (intensity_br + intensity_br2) / 2
intensity_cb <- (intensity_cb + intensity_cb2) / 2
